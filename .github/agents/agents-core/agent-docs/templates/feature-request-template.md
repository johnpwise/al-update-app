...
Describe the user problem, desired outcome, and constraints clearly enough for planning and execution.
...
- [ ] Trigger block includes `Use agent spec: Workflow-Orchestrator`.
